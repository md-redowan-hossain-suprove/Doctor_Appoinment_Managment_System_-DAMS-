...
namespace project
{
    public partial class Admin_Home : Form
    {
        ...
        {
            con.Open();
            SqlDataAdapter sda = new SqlDataAdapter(@"SELECT [First_name]
      ,[Last_Name]
      ,[Gender]
      ,[DOB]
      ,[Edu]
  ...
  FROM [dbo].[Emp_Reg] ", con);
        ...
        {
            if (txt_firstname.Text != null && txt_lastname.Text != null && Gender_pet.Text != null && dateTimePicker1.Text != null && Number.Text != null && txt_gmail.Text != null)
            {
                try
                {
   ...
   SET [Password] = '" + Pass.Text + "' WHERE Email_ID = '" + txt_gmail.Text + "'", con);
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                edu.Text = dataGridView1.SelectedRows[0].Cells[4].Value.ToString();
                ex.Text = dataGridView1.SelectedRows[0].Cells[5].Value.ToString();
                Number.Text = dataGridView1.SelectedRows[0].Cells[6].Value.ToString();
                txt_gmail.Text = dataGridView1.SelectedRows[0].Cells[7].Value.ToString();
        ...
        {
            if (txt_firstname.Text != null && txt_lastname.Text != null && Gender_pet.Text != null && dateTimePicker1.Text != null && edu.Text != null && ex.Text != null && Number.Text != null && txt_gmail.Text != null && Pass.Text != null)
            {
                try
                {
           ...
           ,[P_N]
           ,[Gmail])
     VALUES('" + txt_firstname.Text + "','" + txt_lastname.Text + "','" + Gender_pet.Text + "','" + dateTimePicker1.Text + "', '" + edu.Text + "', '" + ex.Text + "', '" + Number.Text + "','" + txt_gmail.Text + "')", con);
     ...
     VALUES('" + txt_gmail.Text + "','" + Pass.Text + "','" + Emp_lvl.Text + "')", con);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand(@"DELETE FROM [dbo].[Emp_Reg]
      WHERE Gmail= '" + txt_gmail.Text + "'", con);
      ...
      WHERE Email_ID = '" + txt_gmail.Text + "'", con);
        ...
        {
            SqlDataAdapter sda = new SqlDataAdapter("select * from Emp_Reg where First_name like '%" + textBox1.Text + "%'", con);
            SqlDataAdapter sda1 = new SqlDataAdapter("select * from Emp_Reg where Last_name like '%" + textBox1.Text + "%'", con);
            SqlDataAdapter sda2 = new SqlDataAdapter("select * from Emp_Reg where Gmail like '%" + textBox1.Text + "%'", con);
